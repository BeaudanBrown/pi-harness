...
stops at `/aloop-authorize-recovery <issue> <attempt-key>`, a
recovery-specific human approval bound to the accepted attempt, rather than
allowing an unrelated decision or arbitrary issue text to become closure
