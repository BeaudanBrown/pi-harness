...
export PI_R_DATA_INSPECTOR_SCRIPT="\''${PI_R_DATA_INSPECTOR_SCRIPT:-${piRPackage.resourcePaths.dataInspector}}"
export PI_R_SANDBOX_PATH="\''${PI_R_SANDBOX_PATH:-${piRPackage.resourcePaths.sandboxRuntimePath}}"
